...
namespace RodriBus.MartianRobots.UnitTests.Application
{
    public class RectangleMapTests
    {
        ...
        public RectangleMapTests()
        {
            ...
            {
                Origin = CoordinatesViewModel.Zero,
                Height = 5,
                Width = 5,
            };
        ...
        public void ShouldSetTopRightCoordinates()
        {
            ...
            Map.TopRight.Should().Be(new CoordinatesViewModel(4, 4));
        }
        ...
        {
            // Arrange
            var initialCoords = new CoordinatesViewModel(1, 1);

            // Act
            var result = Map.GetNextCoordinates(initialCoords, Orientation.North);

            // Assert
            result.Should().Be(new CoordinatesViewModel(1, 2));
        }
        ...
        public void GetNextCoordinatesShouldWorkProperly(Orientation orientation, int xExpected, int yExpected)
        {
            ...
            // Assert
            result.Should().Be(new CoordinatesViewModel(xExpected, yExpected));
        }
        ...
        {
            // Arrange
            var outOfBounds = Map.TopRight + new CoordinatesViewModel(1, 1);
        ...
        {
            // Arrange
            var outOfBounds = Map.Origin + new CoordinatesViewModel(1, 1);
