...
namespace RodriBus.MartianRobots.Application.Maps
{
    ...
    public class RectangleMap : IPlanetMap
    {
        ...
        /// Origin coordinates.
        /// </summary>
        public CoordinatesViewModel Origin { get; private set; }

        /// <summary>
        /// Top right coordinates.
        /// </summary>
        public CoordinatesViewModel TopRight { get; private set; }

        private readonly IDictionary<CoordinatesViewModel, List<Landmark>> Landmarks = new Dictionary<CoordinatesViewModel, List<Landmark>>();
        ...
        {
            TopRight = new CoordinatesViewModel(configuration.Height - 1, configuration.Width - 1);
        ...
        /// Gets map landmarks.
        /// </summary>
        public IDictionary<CoordinatesViewModel, IEnumerable<Landmark>> GetLandmarks() => Landmarks.ToDictionary(l => l.Key, l => l.Value.AsEnumerable());
        ...
        public CoordinatesViewModel GetNextCoordinates(CoordinatesViewModel coordinates, Orientation orientation)
        {
            ...
            return coordinates + new CoordinatesViewModel(xAmmount, yAmmount);
        }
