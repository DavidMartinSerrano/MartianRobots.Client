...
var config = new PlanetMapConfiguration { Height = marsHeight, Width = marsWidth, Origin = CoordinatesViewModel.Zero };
...
foreach (var pair in instructionPairs)
{
    ...
    // SET UP NEW ROBOT
    control.DeployRobot(new RobotViewModel(coord, or));
