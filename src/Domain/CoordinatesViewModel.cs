...
namespace RodriBus.MartianRobots.Domain
{
    ...
    public struct CoordinatesViewModel : IEquatable<CoordinatesViewModel>
    {
        ...
        /// </summary>
        public static CoordinatesViewModel Zero => new CoordinatesViewModel(0, 0, 0);
        ...
        /// Creates an instance.
        /// </summary>
        public CoordinatesViewModel(int x, int y, int z = 0)
        {
            ThrowIfOverLimit(x);
            ThrowIfOverLimit(y);
            ThrowIfOverLimit(z);
        ...
        /// Sum operator.
        /// </summary>
        public static CoordinatesViewModel operator +(CoordinatesViewModel a, CoordinatesViewModel b) =>
            new CoordinatesViewModel(a.X + b.X, a.Y + b.Y, a.Z + b.Z);

        /// <summary>
        /// Equals operator.
        /// </summary>
        public static bool operator ==(CoordinatesViewModel a, CoordinatesViewModel b) => a.Equals(b);
        ...
        public bool Equals(CoordinatesViewModel instance)
        {
        ...
        {
            if (obj is CoordinatesViewModel instance)
